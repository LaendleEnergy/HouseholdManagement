...
insert into device (device_name, household_id, category_name) values ('Testname1', 'h1', 'Kuehlschrank');
insert into device (device_name, household_id, category_name) values ('Testname2', 'h1', 'Kuehlschrank');
